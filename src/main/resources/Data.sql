...
INSERT INTO tool (id, tool_name, type, user_id,description) VALUES (1006, 'Makita P-90635 118-delig','	Gereedschapskoffer', 'user','Neem de Makita P-90635 118-delig mee als je gaat klussen en de kans dat je misgrijpt is bijzonder klein. De 118-delige set bestaat uit allerlei verschillende maten bits, doppen, ringsleutels en andere onmisbare accessoires voor de serieuze klusser.');
INSERT INTO tool (id, tool_name, type, user_id,description) VALUES (1007, 'Karcher K7 Premium Power Control Home','hogedrukreinigers', 'user','Deze versie van de Karcher K7 Premium Power Control Home heeft een haspel, zodat je de 10 meter lange slang zonder knikken oprolt. Daarnaast krijg je een terrasreiniger en steen- en gevelreiniger meegeleverd. ');
INSERT INTO tool (id, tool_name, type, user_id,description) VALUES (1008, 'kruiwagen','Kruiwagen', 'user','Let op: Door de afwijkende verpakkingsvorm van kruiwagens is het lastig onze artikelen extra beschermd aan te bieden bij onze vervoerders. Hierdoor kan het voorkomen dat er tijdens het vervoer lichte beschadigingen ontstaan.');
INSERT INTO tool (id, tool_name, type, user_id,description) VALUES (1009, 'Fiskars 1028542 Spade','Schop', 'user','Voor het verplaatsen van zand, grond, gravel of bouwmaterialen is een robuuste schep nodig. Met dit gereedschap, sterk gebouwd en uitgerust met een breed blad, is de klus in een handomdraai geklaard.');
